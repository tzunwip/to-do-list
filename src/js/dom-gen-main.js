...
import { getBreakDates, assembleDueDateCriteria, getVerboseDate, displayElement, findElement } from "./utility-functions";
...
export const generateHome = () => {
  ...
  const month = generateSection(main, {
    title: `${verboseMonth}`,
    classList: "month",
    criteria: assembleDueDateCriteria(weekCriteria.laterDays.dueDate.upperBound, breakDates.monthEnd),
  })
